...
/**
 * Performance test for the Cr_element entity.
 */
class Cr_elementGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Cr_element entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created cr_element")
                .get("${new_cr_element_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created cr_element")
            .delete("${new_cr_element_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
